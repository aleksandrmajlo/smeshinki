 ...
 * Class Anecdote
 *
 * @property \App\Models\Anecdote $model
 *
 * @see https://sleepingowladmin.ru/#/ru/model_configuration_section
 */
class Anecdote extends Section implements Initializable
{
    /**
     * @var bool
     */
    ...
    {
        $this->addToNavigation()->setPriority(200)->setIcon('fa fa-bug');
    }
    ...
    public function onEdit($id = null, $payload = [])
    {
        $form = AdminForm::card()->addBody([
            AdminFormElement::columns()->addColumn([
                ...
                AdminFormElement::wysiwyg('description', 'Зміст')->required(),
